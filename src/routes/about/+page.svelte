...
<section>
	...
	<p class="mt-3">
		...
		with programming one day. whether that will ever happen is tbd.
	</p>
	<p class="mt-3">
		i now live in houston, texas with my wife <span role="img" aria-label="Woman emoji">👩</span>,
		our daughter
		<span role="img" aria-label="Baby emoji">👶</span>, and our dog
